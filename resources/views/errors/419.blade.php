                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            <h1 class="display-5 fw-medium my-4">Your session has expired due to inactivity!</h1>
                            <h4 class="text-uppercase">Please refresh the page. Don't worry, we log out you to keep data safe.</h4>
                            <div class="mt-5 text-center">
                                <a class="btn btn-primary waves-effect waves-light" href="{{route('master.home')}}">Back to Dashboard</a>
                            </div>
                        </div>
                    </div>
                </div>
