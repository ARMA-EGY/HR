                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">{{__('master.EMPLOYEE-DETAILS')}}</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">{{__('master.EMPLOYEES')}}</a></li>
                                        <li class="breadcrumb-item active">{{__('master.EMPLOYEE-DETAILS')}}</li>
                                    </ol>
                                </div>
                                ...
                                <div class="card-body text-left">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            ...
                                            <div class="mb-1">
                                                <input id="job_position" name="job_position" type="text" placeholder="{{__('master.JOB-POSITION')}}" class="form-control" value="{{ isset($item) ? $item->job_position : old('job_position') }}" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input class="form-control form-control-sm" type="text" name="work_mobile" id="work_mobile" value="{{ isset($item) ? $item->work_mobile : old('work_mobile') }}" disabled>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input class="form-control form-control-sm" type="text" name="work_phone" id="work_phone" value="{{ isset($item) ? $item->work_phone : old('work_phone') }}" disabled>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input class="form-control form-control-sm" type="text" name="work_email" id="work_email" value="{{ isset($item) ? $item->work_email : old('work_email') }}" disabled>
                                        </div>
                                        <label for="coach_id" class="col-md-2 col-form-label pb-2 pt-1">{{__('master.COACH')}}</label>
                                        <div class="col-md-4">
                                            <select class="form-control form-control-sm select2" name="coach_id" id="coach_id" disabled>
                                        ...
                                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4" id="work_address_response">
                                                    <select class="form-control form-control-sm select2" name="work_address_id" id="work_address_id" disabled>
                                                ...
                                                <div class="col-md-4" id="work_location_response">
                                                    <select class="form-control form-control-sm select2" name="work_location_id" id="work_location_id" disabled>
                                                        <option value="">{{__('master.SELECT')}}</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control form-control-sm" type="text" name="time_off" id="time_off" value="{{ isset($item) ? $item->time_off : old('time_off') }}" disabled>
                                                </div>
                                                <label for="expense" class="col-md-2 col-form-label pb-2 pt-1">{{__('master.EXPENSE')}}</label>
                                                <div class="col-md-4">
                                                    <input class="form-control form-control-sm" type="text" name="expense" id="expense" value="{{ isset($item) ? $item->expense : old('expense') }}" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4" id="working_hour_response">
                                                    <select class="form-control form-control-sm select2" name="working_hour_id" id="working_hour_id" disabled>
                                                        <option value="">{{__('master.SELECT')}}</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control form-control-sm" type="text" name="default_planning_role" id="default_planning_role" value="{{ isset($item) ? $item->default_planning_role : old('default_planning_role') }}" disabled>
                                                </div>
                                                <label for="planning_roles" class="col-md-2 col-form-label pb-2 pt-1">{{__('master.PLANNING-ROLES')}}</label>
                                                <div class="col-md-4">
                                                    <input class="form-control form-control-sm" type="text" name="planning_roles" id="planning_roles" value="{{ isset($item) ? $item->planning_roles : old('planning_roles') }}" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8" id="address_response">
                                                            <select class="form-control form-control-sm select2" name="address_id" id="address_id" disabled>
                                                                <option value="">{{__('master.SELECT')}}</option>
                                                                @foreach($workAddress as $address)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="email" name="email" id="email" value="{{ isset($item) ? $item->email : old('email') }}" disabled>
                                                        </div>                                  
                                                    </div>
                                                    <div class="row">
                                                        <label for="phone" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.PHONE')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="number" name="phone" id="phone" value="{{ isset($item) ? $item->phone : old('phone') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="language_id" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.LANGUAGE')}}</label>
                                                        <div class="col-md-8">
                                                            <select class="form-control form-control-sm select2" name="language_id" id="language_id" disabled>                                                          
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="number" name="home_work_distance" id="home_work_distance" value="{{ isset($item) ? $item->home_work_distance : old('home_work_distance') }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control form-control-sm select2" name="nationality_id" id="nationality_id" disabled>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="identification_no" id="identification_no" value="{{ isset($item) ? $item->identification_no : old('identification_no') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="passport" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.PASSPORT-NUMBER')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="passport" id="passport" value="{{ isset($item) ? $item->passport : old('passport') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="gender" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.GENDER')}}</label>
                                                        <div class="col-md-8">
                                                            <select class="form-control form-control-sm select2" name="gender" id="gender" disabled>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="date" name="dateofbirth" id="dateofbirth" value="{{ isset($item) ? $item->dateofbirth : old('dateofbirth') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="placeofbirth" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.PLACE-OF-BIRTH')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="placeofbirth" id="placeofbirth" value="{{ isset($item) ? $item->placeofbirth : old('placeofbirth') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="countryofbirth_id" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.COUNTRY-OF-BIRTH')}}</label>
                                                        <div class="col-md-8">
                                                        <select class="form-control form-control-sm select2" name="countryofbirth_id" id="countryofbirth_id" disabled>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control form-control-sm select2" name="maritalstatus_id" id="maritalstatus_id" disabled>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="number" name="no_ofchildren" id="no_ofchildren" value="{{ isset($item) ? $item->no_ofchildren : old('no_ofchildren') }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="emergency_contact" id="emergency_contact" value="{{ isset($item) ? $item->emergency_contact : old('emergency_contact') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="emergency_phone" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.EMERGENCY-PHONE')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="number" name="emergency_phone" id="emergency_phone" value="{{ isset($item) ? $item->emergency_phone : old('emergency_phone') }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="number" name="visa_no" id="visa_no" value="{{ isset($item) ? $item->visa_no : old('visa_no') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="work_permit_no" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.WORK-PERMIT-NUMBER')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="number" name="work_permit_no" id="work_permit_no" value="{{ isset($item) ? $item->work_permit_no : old('work_permit_no') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="visa_expire_date" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.VISA-EXPIRE-DATE')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="date" name="visa_expire_date" id="visa_expire_date" value="{{ isset($item) ? $item->visa_expire_date : old('visa_expire_date') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="work_permit_expire_date" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.WORK-PERMIT-EXPIRATION-DATE')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="date" name="work_permit_expire_date" id="work_permit_expire_date" value="{{ isset($item) ? $item->work_permit_expire_date : old('work_permit_expire_date') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="work_permit" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.WORK-PERMIT')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="file" name="work_permit" id="work_permit" value="{{ isset($item) ? $item->work_permit : old('work_permit') }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                        <select class="form-control form-control-sm select2" name="certificate_level_id" id="certificate_level_id" disabled>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="field_of_study" id="field_of_study" value="{{ isset($item) ? $item->field_of_study : old('field_of_study') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="school" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.SCHOOL')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="school" id="school" value="{{ isset($item) ? $item->school : old('school') }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control form-control-sm select2" name="type_id" id="type_id" disabled>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="related_user" id="related_user" value="{{ isset($item) ? $item->related_user : old('related_user') }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="pin_code" id="pin_code" value="{{ isset($item) ? $item->pin_code : old('pin_code') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <label for="badge_id" class="col-md-4 col-form-label pb-2 pt-1">{{__('master.BADGE-ID')}}</label>
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="badge_id" id="badge_id" value="{{ isset($item) ? $item->badge_id : old('badge_id') }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="current_contract" id="current_contract" value="{{ isset($item) ? $item->current_contract : old('current_contract') }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control form-control-sm" type="text" name="fleet_mobility_card" id="fleet_mobility_card" value="{{ isset($item) ? $item->fleet_mobility_card : old('fleet_mobility_card') }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
