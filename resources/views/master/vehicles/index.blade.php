                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($items as $item)
                                                    <tr>
                                                        ...
                                                        <td><a href="#" class="text-body fw-bold">{{$item->model}}</a> </td>
                                                        <td>{{$item->license_plate}}</td>
                                                        <td>{{$item->chassis_number}}</td>
                                                        <td>{{ !empty($item->diver) ? $item->diver->name:'-' }}</td>
                                                        <td>
                                                            <div class="d-flex gap-3">
                                                                <a data-toggle="tooltip" data-placement="top" title="{{__('master.VIEW-DETAILS')}}" href="{{route('master.vehicles.show', $item->id)}}" class="btn-primary py-1 px-2 btn-rounded"><i class="mdi mdi-eye font-size-18"></i></a>
                                                                <a data-toggle="tooltip" data-placement="top" title="{{__('master.EDIT')}}" href="{{route('master.vehicles.edit', $item->id)}}" class="btn-success py-1 px-2 btn-rounded"><i class="mdi mdi-pencil font-size-18"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
