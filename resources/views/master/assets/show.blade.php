                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">{{__('master.SHOW-ASSETS')}}</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">{{__('master.ASSETS')}}</a></li>
                                        <li class="breadcrumb-item active">{{__('master.SHOW-ASSETS')}}</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8 col-10">
                                                <div class="mb-4">
                                                    <input id="name" name="name" type="text" placeholder="Name" class="form-control" value="{{ isset($item) ? $item->name : old('name') }}" disabled>
                                                </div>
                                            </div>
                                        </div>
