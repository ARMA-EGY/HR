                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="text-sm-end">
                                                <a href="#" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> Add New Work Schedule</a>
                                            </div>
                                        </div><!-- end col-->
                                    </div>
                                        ...
                                        <table class="table align-middle table-nowrap table-check">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th class="align-middle">Average Hour per Day</th>
