                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">{{__('master.ALL-WORKSPACES')}}</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">{{__('master.WORKSPACES')}}</a></li>
                                        <li class="breadcrumb-item active">{{__('master.ALL-WORKSPACES')}}</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="text-right">
                                                <a href="{{route('master.workspace.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> Add New Workspaces</a>
                                            </div>
                                        </div><!-- end col-->
                                    </div>
